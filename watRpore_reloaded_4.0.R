...
#   }
# }
ncfname <- paste("./030/030_strip.nc")
monomer_count <- 4
...
for (monomer in monomer_names) {
  ...
  assign(paste("WAT_", monomer, "_atoms", sep = ""),
...
for (monomer in monomer_names) {
  ...
  assign(paste("longitud_tubo_", monomer, sep = ""),
         mean(
           ncvar_get(
             ncin,
             "coordinates",
